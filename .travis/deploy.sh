...
ssh marco@51.77.202.182 -p 4242 "bash -c 'cd apps/AREA && source .travis/.production_env && docker-compose up --build -d client_web docs && sudo mv /home/marco/area.apk /var/lib/docker/volumes/area_common-data/_data/'"
